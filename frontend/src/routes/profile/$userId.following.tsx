...
import { useFollowing, useFollowStatus, useFollow, useUnfollow } from '@/hooks/useProfile';
...
function FollowingPage() {
  ...
  const { data, isLoading, fetchNextPage, hasNextPage, isFetchingNextPage } = useFollowing(userId);
