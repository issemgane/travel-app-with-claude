...
public class FollowController {
    ...
    public ResponseEntity<PagedResponse<UserDto>> getFollowers(
        ...
        Page<UserDto> followers = followRepository.findFollowerIds(id, pageable)
                .map(uid -> userService.getById(uid));
    ...
    public ResponseEntity<PagedResponse<UserDto>> getFollowing(
            @PathVariable UUID id, Pageable pageable) {
        Page<UserDto> following = followRepository.findFollowingIds(id, pageable)
                .map(uid -> userService.getById(uid));
