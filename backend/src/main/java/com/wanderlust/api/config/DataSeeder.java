...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        for (User follower : users) {
            ...
            int count = 3 + rng.nextInt(4); // follow 3-6 people
        ...
        Object[][] postData = {
            // {userIndex, content, category, costLevel, bestSeason, duration, lat, lng, placeName, countryCode, tags, imageUrl}
            ...
            {3, "The Northern Lights in Tromsø exceeded all expectations. We booked a guided chase tour and they drove us 2 hours outside the city to clear skies. Absolutely magical experience.", PostCategory.ACTIVITY, (short)4, "WINTER", "3-4 days", 69.6492, 18.9553, "Tromsø", "NO", "northernlights,norway,aurora", "https://images.unsplash.com/photo-1483347756197-71ef80e95f73?w=800"},
            ...
            {4, "This all-inclusive resort in Cancún has an amazing kids club. Parents can actually relax while the little ones are entertained. The beach is pristine and calm enough for toddlers.", PostCategory.STAY, (short)4, "WINTER", "5-7 days", 21.1619, -86.8515, "Cancún", "MX", "cancun,family,resort", "https://images.unsplash.com/photo-1510414842594-a61c69b5ae57?w=800"},
            ...
            {6, "Medellín's transformation is incredible. The cable cars, street art in Comuna 13, perfect weather year-round. Coffee tours in nearby farms are a must. Best city in Colombia.", PostCategory.SPOT, (short)1, "SPRING", "5-7 days", 6.2442, -75.5812, "Medellín", "CO", "colombia,medellin,culture", "https://images.unsplash.com/photo-1568605117036-5fe5e7bab0b7?w=800"},
